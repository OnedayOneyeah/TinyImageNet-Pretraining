...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=200, norm_layer=None):
    ...
    def _make_layer(self, block, planes, num_blocks, stride, norm_layer):
        ...
        # return nn.Sequential(*layers).apply(weight_init_kaiming_uniform)
    ...
    def forward(self, x):
        ...
        # print(out.shape)
        out = self.layer4(out)
        print("layer4",out.shape) # (1, 2048, 8, 8)
